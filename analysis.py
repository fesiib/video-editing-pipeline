...
def summarize_pipeline_results_interpretation():
    MIOU_THRESHOLD = 0.1
    ...
    file_prefix = "{PIPELINE_RESULTS_FOLDER}/evaluation_result_"
    combined_results = {}
...
def summarize_pipeline_results_parsing():
    ...
    file_prefix = "{PIPELINE_RESULTS_FOLDER}/evaluation_parsing_"
    results = []
    for task_id in range(2, 7):
        filename = file_prefix + str(task_id) + ".json"
        with open(filename, "r") as f:
...
def summarize_pipeline_results_spatial():
    ...
    file_prefix = "{PIPELINE_RESULTS_FOLDER}/spatial_evaluation_"
    combined_results = {}
    for task_id in range(2, 7):
        filename = file_prefix + str(task_id) + ".json"
        print("task", task_id)
...
def combine_pipeline_results():
    results_prefix = "{PIPELINE_RESULTS_FOLDER}/evaluation_result_"
    logs_prefix = "{PIPELINE_RESULTS_FOLDER}/evaluation_all_"
    combined_results = []
    ...
    with open("{PIPELINE_RESULTS_FOLDER}/evaluation_combined.json", "w") as f:
        json.dump(combined_results, f, indent=4)

def summarize_pipeline_results():
    summarize_pipeline_results_parsing()
    print("!!!!!!!!!!!"*5)
    summarize_pipeline_results_interpretation()
    print("!!!!!!!!!!!"*5)
